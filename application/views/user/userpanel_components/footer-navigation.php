    		...
    		<div class="container">
    			<div class="row">
    								...
    								<div class="row ">
    									<div class="col-6  ">
    										<a class="app-icon" target="_blank"  href="https://itunes.apple.com/">
    											...
    											<img src="<?php echo base_url();?>assets/userpanel/images/site/app_store_badge.svg" alt="Available on the App Store">
    										</a>
    									</div>
    									<div class="col-6  ">
    										<a class="app-icon"  target="_blank" href="https://play.google.com/store/">
    											<span class="hide-visually">Android App</span>
    											<img src="<?php echo base_url();?>assets/userpanel/images/site/google-play-badge.svg" alt="Available on the App Store">
    										</a>
    									</div>
    								</div>
    							</div>
    				...
    				<!-- 	<div class=" text-center paymanet-method-logo">
    						...
    						<img src="<?php //echo base_url();?>assets/userpanel/images/site/payment/master_card.png" alt="img">
    						<img alt="img" src="<?php //echo base_url();?>assets/userpanel/images/site/payment/visa_card.png">
    						<img alt="img" src="<?php //echo base_url();?>assets/userpanel/images/site/payment/paypal.png">
    						<img alt="img" src="<?php //echo base_url();?>assets/userpanel/images/site/payment/american_express_card.png"> <img alt="img" src="<?php //echo base_url();?>assets/userpanel/images/site/payment/discover_network_card.png">
    						<img alt="img" src="<?php //echo base_url();?>assets/userpanel/images/site/payment/google_wallet.png">
    					</div> -->
                        <hr/>
    					<div class="copy-info text-center">
    						&copy; 2019 Grocery Shop. All Rights Reserved.
    					</div>
