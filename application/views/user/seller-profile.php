                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="seller-profile-img">
                                            <a><img src="images/user.jpg" class="img-responsive thumbnail" alt="img"> </a>
                                        </div>
                                    </div>
                                        <div class="col-md-9">
                                            <h3 class="no-margin no-padding link-color uppercase "> Richard Aki</h3>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="seller-contact-info">
                                ...
                                <dl class="dl-horizontal">
                                    ...
                                    <dt>Address:</dt>
                                    <dd class="contact-sensitive"> 2142 Columbia Boulevard <br>
                                        Baltimore, MD 21212
                                    </dd>
                                    <dt>Telephone:</dt>
                                    ...
                                    <dt>Fax:</dt>
                                    <dd class="contact-sensitive">0021-321-23456</dd>
                                </dl>
                            ...
                            <div class="category-list">
                                <div class="tab-box ">
                                    ...
                                    <ul class="nav nav-tabs add-tabs" role="tablist">
                                        <li class="active nav-item"><a href="#allAds" role="tab" data-toggle="tab" class="nav-link">User all ads <span class="badge badge-pill badge-secondary">228,705</span></a>
                                        </li>
                                    </ul>
                                ...
                                <div class="listing-filter">
                                    <div class="pull-left col-xs-6">
                                        <div class="breadcrumb-list"><a href="#" class="current">
                                            <span>All ads</span></a> in New York <a href="#selectRegion"
                                                                                    id="dropdownMenu1"
                        ...
                        <div class="col-md-3  page-sidebar-right">
                            <aside>
                                <div class="card sidebar-card card-contact-seller">
                                    <div class="card-header">Follwing <span class="badge badge-secondary">3</span>
                                    </div>
                                ...
                                <div class="card sidebar-card card-contact-seller">
                                    <div class="card-header">Followers <span class="badge badge-secondary">81</span>
                                    </div>
                                    <div class="card-content user-info">
                                        <div class="card-body text-center">
