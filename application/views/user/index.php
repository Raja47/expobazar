    ...
    <div class="main-container mt-5">
        ...
        <div class="container">
                ...
                <div class="row" style="margin-top:30px;">
                    <div class="col-lg-5 page-sidebar col-thin-left ">
                        <aside>
                          ...
                          <!--   <div class="inner-box">
                            ...
                            <div class="row row-featured row-featured-category depth-1">
                    <div class="col-xl-12  box-title no-border ">
                        <div class="inner"><h2><span></span>
                            Browse By Category <a href="<?php echo base_url();?>cat" class="sell-your-item"> View more <i
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-3 col-xs-4 f-category">
                ...
                ?>    
                    ...
                    <div class="col-lg-7">
                             <div class="col-xl-12  box-title no-border">
                        <div class="inner"><marquee><h2><span></span>
                            Youngs Chicken Spread Bbq Pouch
200 ml <a href="<?php echo base_url();?>user/category" class="sell-your-item">   </a></h2></marquee>
                        </div>
                    </div>
                      <div id="owl-demo" class="owl-carousel ">
                        ...
                        <div class="item depth-1"><img class="lazyOwl" data-src="<?php echo base_url().$banner->pic_location; ?>" alt="no found"></div>
                ...
                <div class="row row-featured row-featured-category">
                    <div class="col-xl-12  box-title no-border">
                        <div class="inner"><h2><span>Browse by</span>
                            Category <a href="<?php echo base_url();?>user/category" class="sell-your-item"> View more <i
                                    class="  icon-th-list"></i> </a></h2>
                        </div>
                    </div>
                    <?php foreach($categories as $category):?>
                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="<?php echo base_url(); ?>user/category/<?php echo $category->id; ?>" ><img src="<?php echo base_url()."".$category->pic_location;?>" class="img-responsive" alt="<?php echo $category->name; ?>">
                            <h6><?php echo $category->name; ?></h6></a>
                    </div>
                    <?php endforeach;?>    
            ...
            <div class="col-xl-12 content-box ">
                <div class="row row-featured">
                    <div class="col-xl-12  box-title ">
                        <div class="inner"><h2><span>Latest </span>
                            Products <a href="<?php echo base_url();?>user/category" class="sell-your-item"> View more <i
                                    class="  icon-th-list"></i> </a></h2>
                ...
                <div class="col-lg-12 pb-5">
                    <div class="owl-carousel owl-theme mt-3 product product-slider">
                        <?php foreach ($carouselProducts as $prd ): ?>
                        <div class="item">
                                <a href="<?php echo base_url().'prd/'.$prd->slug; ?>">
                             <span class="item-carousel-thumb">
                                <img class="img-responsive" src="<?php echo base_url().$prd->pic_location;?>" alt="img">
                             </span>
                                <span class="item-name"> <?php echo $prd->title; ?> </span>
                                <span class="price">  <?php echo'PKR '.$prd->sale_price; ?> </span>
                                </a>
                        </div>
                        <?php endforeach; ?>   
        ...
        <div class="page-bottom-info-inner">
            ...
            <div class="page-bottom-info-content text-center">
                <h1>If you have any questions, comments or concerns, please call the Classified Advertising department
                    at (000) 555-5556</h1>
                <a class="btn  btn-lg btn-default" href="tel:+000000000">
