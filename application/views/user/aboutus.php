...
<div id="wrapper">
    ...
    background:url(<?php echo base_url();?>assets/images/bg2.jpg) no-repeat center;
        ...
        <div class="container">
            <div class="section-content">
                <div class="row ">
                    ...
                    <div class="col-sm-6"><img src="<?php echo base_url();?>assets/images/info.png" alt="imfo" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
