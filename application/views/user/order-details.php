        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 page-content">
                    <div class="inner-box">
                        <h2 class="title-2"><i class="icon-money"></i> Order-Id #
                          <?php echo $products[0]->id;  ?></h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                "<tr>
                                    ...
                                    <td>".($product->sale_price)*($product->discount_percentage/100)."</td>
                                    <td>".$product->quantity*($product->sale_price-($product->sale_price)*($product->discount_percentage/100))."
                                    </td>
                                    
                                </tr>";
                                $count++;
                                $sum+=$product->sale_price;
                                $sum_discount+=($product->sale_price)*($product->discount_percentage/100);
                                $sum_total+=$product->quantity*($product->sale_price-($product->sale_price)*($product->discount_percentage/100));
                                endforeach;
                                ?>
                                <thead>
                                <tr> 	    
                             	    <th colspan="3" text-align="center" >Total </th>
