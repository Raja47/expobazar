...
<div id="wrapper">
    ...
    <div class="intro has-map"  style="background-image: url(images/bg3.jpg);">
            ...
            <div class="w100 content-box content-box-map no-bg">
                <div class=" row-featured row-featured-category">
                    <div class="  box-title no-border">
                        <div class="inner">
                            <h2> <span class="icon-map"></span> <span>Browse by</span>

                                REGION <a href="category.html" class="sell-your-item"> View more <i class="  icon-th-list"></i> </a></h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div id="map-list" class="row">
                                <ul class="list-link list-unstyled col-xl-4 col-4">
                                    ...
                                    <li><a href="#" title="Alabama">Alabama</a>
                                    </li>
                                    <li><a href="#" title="Alaska">Alaska</a>
                                    </li>
                                    <li><a href="#" title="Arizona">Arizona</a>
                                    </li>
                                    <li><a href="#" title="Arkansas">Arkansas</a>
                                    </li>
                                    <li><a href="#" title="California">California</a>
                                    </li>
                                    <li><a href="#" title="Colorado">Colorado</a>
                                    </li>
                                    <li><a href="#" title="Florida">Florida</a>
                                    </li>
                                    <li><a href="#" title="Georgia">Georgia</a>
                                    </li>
                                    <li><a href="#" title="Hawaii">Hawaii</a>
                                    </li>
                                    <li><a href="#" title="Idaho">Idaho</a>
                                    </li>
                                </ul>
                                <ul class="list-link list-unstyled col-xl-4 col-4">
                                    <li><a href="#" title="Indiana">Indiana</a>
                                    </li>
                                    <li><a href="#" title="Iowa">Iowa</a>
                                    </li>
                                    <li><a href="#" title="Kansas">Kansas</a>
                                    </li>
                                    <li><a href="#" title="Kentucky">Kentucky</a>
                                    </li>
                                    <li><a href="#" title="Louisiana">Louisiana</a>
                                    </li>
                                    <li><a href="#" title="Maine">Maine</a>
                                    </li>
                                    <li><a href="#" title="Maryland">Maryland</a>
                                    </li>
                                    <li><a href="#" title="Michigan">Michigan</a>
                                    </li>
                                    <li><a href="#" title="Minnesota">Minnesota</a>
                                    </li>
                                    <li><a href="#" title="Missouri">Missouri</a>
                                    </li>
                                    <li><a href="#" title="Montana">Montana</a>
                                    </li>
                                </ul>
                                <ul class="list-link list-unstyled col-xl-4 col-4">
                                    <li><a href="#" title="Oceanside">Nebraska</a>
                                    </li>
                                    <li><a href="#" title="Orangeburg">New Jersey</a>
                                    </li>
                                    <li><a href="#" title="Orient">New Mexico</a>
                                    </li>
                                    <li><a href="#" title="Ozone Park">New York</a>
                                    </li>
                                    <li><a href="#" title="Palatine Bridge">North Carolina</a>
                                    </li>
                                    <li><a href="#" title="Patterson">Oklahoma</a>
                                    </li>
                                    <li><a href="#" title="Pearl River">Tennessee</a>
                                    </li>
                                    <li><a href="#" title="Peekskill">Texas</a>
                                    </li>
                                    <li><a href="#" title="Pelham">Virginia</a>
                                    </li>
                                    <li><a href="#" title="Penn Yan">Washington</a>
                                    </li>
                                    <li><a href="#" title="Peru">West Virginia</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        $('#country-map').twism("create",
                {
                    map: "custom",
                    customMap: 'images/maps/Blank_US_territories.svg',
