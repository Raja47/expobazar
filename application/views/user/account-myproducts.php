               ...
               <?php include('userpanel_components/account-asside.php'); ?>
                ...
                <div class="col-md-9 page-content">
                    <div class="inner-box inner-box">
                        <h2 class="title-2"><i class="icon-docs"></i> My Products
                         </h2>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="addManageTable"
                                ...
                                <tr>
                                    ...
                                    <td style="width:14%" class="add-img-td"><a href="ads-details.php"><img
                                            class="thumbnail  img-responsive"
                                            src="<?php echo base_url().$prd->pic_location; ?>"
                                            alt="img"></a></td>
                                    <td style="width:58%" class="ads-details-td">
                                        <div>
                                            <p><strong> <a href="ads-details.php" title="Brand New Nexus 4"><?php echo $prd->title; ?></a> </strong></p>

                                            <p><strong> Posted On </strong>:
                                                <?php echo $prd->created_at; ?> </p>

                                            <p><strong>Located In:<?php echo $prd->city_name ;?></strong> 
                                            </p>
                                        </div>
                                    </td>
                                    <td style="width:16%" class="price-td">
                                        <div><strong><?php echo $prd->sale_price ?></strong></div>
                                    </td>
