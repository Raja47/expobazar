...
<div id="wrapper">
    <div class="main-container">
        <div class="container">
            <div class="row">
                <div class="col-sm-5 login-box depth-1">
                    <div class="card card-default" style="border:0px">
                        <div class="panel-intro text-center">
                            <h2 class="logo-title">
                              ...
                              <h2 class="logo-title">
                                <!-- Original Logo will be placed here  -->
                                <span class="logo-icon"></span> Login<span> </span>
                            </h2>
                            </h2>
                        </div>
                        <div class="card-body">
						    ...
						    ?>    
						          <div class="alert alert-success alert-dismissible fade show" role="alert">
						            ...
						            <strong></strong> <?php echo $success;?> ,Please Login
						          </div>
						     <?php   }
						      ?>
                        	...
                        	<?php
		     				...
		     				<?php   } ?>
                            <form role="form" action="<?php echo base_url(); ?>user/loginUser" method='post' >
                                <div class="form-group">
                                    <label for="sender-email" class="control-label">Username:</label>

                                    <div class="input-icon"><i class="icon-user fa"></i>
                                        <input id="sender-email" type="text" name='loginEmail' placeholder="Username"
                                ...
                                <div class="form-group">
                                    <input type='submit' name='loginuser' class="btn btn-primary  btn-block">
                                </div>
                            </form>
                        </div>
                        <div class="card-footer">
                            ...
                            <p class="text-center pull-right"><a href="<?php echo base_url();?>user/forgotPassword"> Lost your password? </a>
                            </p>
                    ...
                    <div class="login-box-btm text-center">
                        <p> Don't have an account? <br>
                            <a href="<?php echo base_url();?>user/signup"><strong>Sign Up !</strong> </a></p>
                    </div>
                </div>
            </div>
        </div>
