        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php echo form_open_multipart('admin/seoFormPost/'); ?>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form">
                        ...
                        <textarea  type="text" placeholder="Title" name="title" required onkeyup="input(this,'remainingC1','myProgress1','myBar1');" id="title1" class="txt_3"></textarea>
                        <textarea placeholder="Please input your Meta Description" required name="description" type="text" class="txt_3"></textarea>
                        <input type="text"  placeholder="Meta Keyword"  required name="keyword" class="txt">
                        <input type="text"  placeholder="Author name"  name="authorname" class="txt">
                        <input type="text"  placeholder="Copyright"  name="copyright" class="txt">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form">
                        ...
                        <textarea  type="text"  placeholder="Title"  name="og_title" class="txt_3" onkeyup="input(this,'remainingC2','myProgress2','myBar2');" id="title2"></textarea>

                        <textarea type="text"  placeholder="Description"  name="og_description" class="txt_3"></textarea>
                         
                         <input type="text"  placeholder="Site URL" name="og_siteurl" class="txt">
                        <input type="file" placeholder="Image URL" name="og_imageurl" class="txt">
                        <input type="text" placeholder="Site Name"  name="og_sitename" value="bestsongs.pk" class="txt">      
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form">
                        ...
                        <textarea type="text"  placeholder="Title" name="twitter_title" class="txt_3" onkeyup="input(this,'remainingC3','myProgress3','myBar3');" id="title3"></textarea>

                        <textarea type="text" placeholder="Description" name="twitter_description"   class="txt_3"></textarea>
                         <input type="text" placeholder="Sumary"  name="twitter_summary" class="txt">
                         <input type="text"  placeholder="Site" name="twitter_siteurl" value="bestsongs.pk" class="txt">
                        <input type="file" placeholder="image"  name="twitter_imageurl"  class="txt">
                      </div>
                    </div>
                  </div>
                  <br><br>
                    <input type="submit" required="" name="submit" value="Add Tags to page"  class="button" >
                  </div>
              </div>
