                  ...
                  <!-- class="table table-striped table-sm" -->
                    ...
                    <?php  
                      ...
                      ?>    
                        ...
                        <td><?php echo "<button type='button' class='btn btn-success productEdit' value='product_".$product->id."_".$product->subcategory_id."' data-toggle='modal' data-target='#edit_product_modal'>Edit</button>"; ?></td>
                         <?php if($this->session->userdata('adminlogin')){ ?>
            ...
            <form class="form-horizontal" name="form_prdupdate" id="form_prdupdate" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group pmd-selectfield pmd-select-field-floating-label">
                  ...
                  <select name='product_new_select' class="form-control" id="product_new_select" required>
