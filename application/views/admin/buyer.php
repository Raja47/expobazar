                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                                    if($user->status == 1)
                                    {
                                         echo "<button type='button' class='btn btn-danger userbtn' value='block_".$user->id."_buyer'>Block</button>";
                                    }
                                    elseif($user->status == 0)
                                    {     
                                          echo "<button type='button' class='btn btn-success userbtn' value='approve_".$user->id."_buyer'>Approve</button>";
